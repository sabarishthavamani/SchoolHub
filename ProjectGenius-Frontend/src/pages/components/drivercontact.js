...
//import actions
import {  driverAadhar } from '../../actions/adminAction';
...
const DriverContact = (props) => {
  ...
  const {phoneNumber, email, permanentaddress, whatsappNumber, aadhaarNumber, temporaryaddress} = formValue
  const isButtonDisable = (phoneNumber.length === 10 && email !== ""  && permanentaddress !== "" && whatsappNumber.length === 10 && aadhaarNumber.length === 14  && temporaryaddress !== "");
