...
const TeacherContact = (props) => {
  ...
  const isButtonDisable = (phoneNumber.length === 10 && email !== "" && fatherphonenumber.length === 10 && permanentaddress !== "" && whatsappNumber.length === 10 && aadhaarNumber.length === 14 && motherphonenumber.length === 10 && temporaryaddress !== "");
  ...
  return (
      ...
      <form action="" className="teacher-form">
        <div className="teach-box">
            ...
            <input type="text" name="phoneNumber" value={phoneNumber} onChange={handleChange} maxLength={10} onBlur={() => (phoneNumber.length < 10  ? setFocusOnPhoneNum(true) : setFocusOnPhoneNum(false))} />
            {phoneNumber.length < 10 && onFocusPhoneNum &&  <span className='text-error'>Please enter valid 10 digit mobile number</span> }
        </div>
        <div className="teach-box">
            <label htmlFor="">
        ...
        <div className="teach-box">
            ...
            {fatherphonenumber.length < 10 && onFocusFatherNum &&  <span className='text-error'>Please enter valid 10 digit mobile number</span> }
        </div>
        <div className="teach-box">
            <label htmlFor="">
            ...
            { motherphonenumber.length < 10 && onFocusMotherNum &&  <span className='text-error'>Please enter valid 10 digit mobile number</span> }
        </div>
        <div className="teach-box">
            <label htmlFor="">
                Permanent Address
