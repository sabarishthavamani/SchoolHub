                    ...
                    <div className="teacher-details">
                        ...
                        <form action="" className="teacher-form">
                            ...
                            <div className="teach-box">
                                ...
                                <span className='text-error'>{inputErrors.currentsalary}</span>
                            </div>
                            <div className="teach-box">
                                <label htmlFor="">
                            ...
                            <div className="teach-box">
                                ...
                                <input type="file" id="file" name="teacherphoto" onChange={handleFilePhotoChange} />
                    ...
                    <div className="teacher-details" style={{ minHeight: 420 }}>
                        ...
                        <form action="" className="teacher-form">
                            <div className="teach-box">
                                ...
                                <span className='text-error'>{inputErrors.higherqualification}</span>
                            </div>
                            <div className="teach-box">
                                <label htmlFor="">
                                    Blood Group<sup>*</sup>
                            ...
                            <div className="teach-box">
                                ...
                                <span className='text-error'>{inputErrors.teachingexperience}</span>
                            </div>
                            <div className="teach-box">
                                <label htmlFor="">
                            ...
                            <div className="teach-box">
                                ...
                                <span className='text-error'>{inputErrors.teachingcertificates}</span>
                            </div>
                            <div className="teach-box">
                                <label>
                                    Digital Signature
                                </label>
                                <input type="file" id="file" name="teachersignature" onChange={handleFileSignatureChange} accept="image/*,application/pdf" />
                                <label htmlFor="file" className="t-photo">
                                    <div style={{ marginRight: '10px' }}><FontAwesomeIcon icon={faUpload} /></div>
