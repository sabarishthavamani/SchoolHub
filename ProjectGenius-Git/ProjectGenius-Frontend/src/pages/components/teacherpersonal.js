...
const TeacherPersonal = (props) => {
    ...
    const {firstName, dob, experience, placeofbirth, lastName, age,currentsalary, teacherphoto} = formValue

    const isButtonDisable = (firstName !== "" && lastName !== "" && dob !== "" && age !== "" && experience !== "" && currentsalary !== "" && placeofbirth !== "" && teacherphoto !== "");
 return(
    <>
    ...
    <form action="" className="teacher-form">
      <div className="form-left">
        ...
        <div className="teach-box">
          ...
          {errors.experience !== "" &&<span className='text-error'>{errors.experience}</span>}
        </div>
        <div className="teach-box">
          <label htmlFor="">
